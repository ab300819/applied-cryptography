/* ASN.1/cryptlib object dumping code, copyright Peter Gutmann
...
void usageExit( void )
	...
	puts( "Copyright Peter Gutmann 1997, 1998.  Last updated 12 December 1998." );
	puts( "" );
	puts( "Usage: dumpasn1 [-bcdfhlopsxz] <file>" );
